...
>
    ...
    <div class="metadata">
        ...
        <div class="meta-item">
            ...
            <span class="meta-value" style="color: #28a745; font-weight: bold;">{{ number_format($expense->final_price, 2) }}</span>
        </div>
    </div>
            ...
            <tbody>
                @foreach($expense->details as $detail)
                    ...
                    <tr>
                        ...
                        <td style="font-weight: bold;">{{ number_format($maintenance->estimated_cost, 2) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </x-report-table>
    ...
    <x-report-summary :qrCode="$qrCode ?? ''">
        <div class="summary-row">
            ...
            <span>{{ number_format($expense->total_price, 2) }}</span>
        </div>
        ...
        <div class="summary-row" style="color: #dc3545;">
            ...
            <span>- {{ number_format($expense->calculated_discount, 2) }}</span>
        </div>
        @endif

        <div class="summary-row total-row">
            <span><strong>{{ __('owner.expenses.show.totals.final_total') }}:</strong></span>
            <span><strong style="color: #28a745; font-size: 1.1em;">{{ number_format($expense->final_price, 2) }}</strong></span>
        </div>
    </x-report-summary>
