        ...
        <div class="tab-pane fade show active" id="allTab">
            <div class="row mb-3">
                ...
                <div class="col-md-2 d-flex gap-2">
                    <button id="filterBtn" class="btn btn-primary btn-sm px-2 py-0" style="min-width: 50px;">{{ __('owner.dalal_stock_report.filter') }}</button>
                    <button id="resetBtn" class="btn btn-secondary btn-sm px-2 py-0" style="min-width: 50px;">{{ __('owner.dalal_stock_report.reset') }}</button>
                </div>
