...
@section('css')
    <style>
        ...
        .ms-statement-distribution thead th {
            background: #d97706;
        }
        ...
        [data-bs-theme=dark] .ms-statement-wrap {
            background: var(--bs-secondary-bg);
            box-shadow: none;
        }

        [data-bs-theme=dark] .ms-section td {
            background: rgba(255, 255, 255, .05);
            color: var(--bs-emphasis-color);
            border-color: var(--bs-border-color);
        }

        [data-bs-theme=dark] .ms-line td {
            color: var(--bs-body-color);
            border-color: var(--bs-border-color);
        }

        [data-bs-theme=dark] .ms-subtotal td {
            background: rgba(255, 255, 255, .04);
            color: var(--bs-emphasis-color);
            border-color: var(--bs-border-color);
        }

        [data-bs-theme=dark] .ms-subtotal-light td {
            background: transparent;
            border-color: var(--bs-border-color);
        }

        [data-bs-theme=dark] .ms-muted {
...
@section('content')
    ...
    <div class="ms-statement-wrap p-3 p-md-4">
        @include('owner.report._month_summary_statement', [
            'f' => $f,
            'expenses' => $expenses,
            'from' => $from,
            'to' => $to,
