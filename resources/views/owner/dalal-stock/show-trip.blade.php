        ...
        <div class="col-12">
            <div class="card shadow border-primary">
                <div class="card-header fw-bold bg-primary text-white text-center">
                    {{ __('owner.generated.trips_statistics') }}</div>
                <div class="card-body">
                    <div class="row g-3 text-center">
                        <div class="col-6 col-md-4 col-lg-2">
                            <strong>{{ __('owner.generated.trips_count') }}</strong>
                            <span class="badge bg-info fs-6 mt-1" id="tripCount">0</span>
                        </div>
                        <div class="col-6 col-md-4 col-lg-2">
        ...
        <div class="tab-pane fade show active" id="allTab">
            ...
            <div id="datatable" class="mb-5">
                ...
                <table id="datatableDefault" class="table table-sm table-bordered table-hover text-center small-text" style="width:100%">
                    ...
                    <tr>
                        <th>#</th>
                        <th>{{ __('owner.boats.trip_number') }}</th>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var table = $('#datatableDefault').DataTable({
                ...
                ajax: {
                    url: "{{ route('owner.getBoatTripData',$id) }}",
                    data: function (d) {
