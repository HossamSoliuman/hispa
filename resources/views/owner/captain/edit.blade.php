...
@section('title')
    {{ __('owner.generated.edit_captain') }}
@endsection
@section('css')
...
@section('content')
    ...
    <div class="d-flex align-items-center mb-3">
        <div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">{{ __('owner.generated.manage_captain') }}</a></li>
                <li class="breadcrumb-item active">{{ __('owner.generated.edit_captain') }}</li>
            </ul>
            <h1 class="page-header mb-0">{{ __('owner.generated.edit_captain') }}</h1>
        </div>
    ...
    <div id="formControls" class="mb-5">
        <div class="card">
            <div class="card-body pb-2">
                <form action="{{ route('owner.captain.update', $data->id) }}" id="editForm" method="post"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="driving_license_number"
                                value="{{ old('driving_license_number', $data->driving_license_number) }}"
                                class="form-control"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="driving_license_expiry"
                                value="{{ old('driving_license_expiry', $data->driving_license_expiry) }}"
                                class="form-control" required>
