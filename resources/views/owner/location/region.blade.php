...
<div class="d-flex align-items-center mb-3">
    <div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">{{ __('admin.regions.title') }}</a></li>
            <li class="breadcrumb-item active">{{ __('admin.regions.title') }}</li>
        </ul>
...
<div class="modal fade" id="modalCreate">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('owner.regions.store')}}" id="createForm" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 ">
                            ...
                            <div class="form-group ">
                                <label for="name" class="form-label">{{ __('admin.regions.name_ar') }}<span
                                        class="text-danger">*</span></label>
                                <input type="text" name="name" value="{{old('name')}}"
                                    class="form-control  " required
                                    placeholder="{{ __('admin.regions.name_ar') }}">
                        ...
                        <div class="col-6 ">
                            <div class="form-group ">
                                <label for="name_en" class="form-label">{{ __('admin.regions.name_en') }}<span class="text-danger">*</span></label>
                                <input type="text" name="name_en" value="{{old('name_en')}}" class="form-control" required placeholder="{{ __('admin.regions.name_en') }}">
                        ...
                        <div class="col-6 ">
                            <div class="form-check form-switch " style="margin-top: 35px">
                                ...
                                <label class="form-check-label" for="status">{{ __('admin.regions.activate') }}</label>
...
<div class="modal fade" id="editModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('owner.regions.update','update')}}" id="editForm"
                method="post"
                enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-body justify-content-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 ">
                            <div class="form-group ">
                                <label for="name_en" class="form-label">{{ __('admin.regions.name_en') }}<span class="text-danger">*</span></label>
                                <input type="text" name="name_en" id="name_en" value="{{old('name_en')}}" class="form-control" required placeholder="{{ __('admin.regions.name_en') }}">
                                @error('name_en') <span class="text-danger error">{{ $message }}</span>@enderror
                            </div>
                        </div>
...
<div class="modal fade" id="deleteModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('owner.regions.destroy','test') }}" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class=" modal-effect btn btn-outline-danger mb-1 btn-sm"
                                data-id="{{ $info->id }}"
                                data-bs-effect="effect-scale"
                                data-bs-toggle="modal" href="#deleteModel"><i class="bi bi-trash btn-danger fa-fw me-1"></i></button>
