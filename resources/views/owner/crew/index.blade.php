...
@section('title')
    {{ __('owner.generated.item_35ebc9') }}
@endsection
@section('css')
...
@section('content')
    ...
    <div class="d-flex align-items-center mb-3">
        <div>
            <h2 class="mb-2">{{ __('owner.crew.page_header') }}</h2>
        </div>
        <div class="ms-auto">
        <a href="{{route('owner.crew.create')}}"  class="btn btn-outline-theme"><i
            class="fa fa-plus-circle btn-success fa-fw me-1"></i>{{ __('owner.crew.add_new') }}</a>
        </div>
    ...
    <div class="row">
        ...
        @include('owner.components.stat-card', [
            'title' => __('owner.crew.cards.total'),
        ...
        @include('owner.components.stat-card', [
            'title' => __('owner.crew.cards.active'),
        ...
        @include('owner.components.stat-card', [
            'title' => __('owner.crew.cards.inactive'),
        ...
        @include('owner.components.stat-card', [
            'title' => __('owner.crew.cards.active_percent'),
        ...
        <div class="tab-pane fade show active" id="allTab">
            ...
            <div id="datatable" class="mb-5">
                ...
                <table id="datatableDefault" class="table table-sm table-bordered table-hover text-center small-text" style="width:100%">
                    ...
                    <tr>
                        <th>{{ __('owner.crew.table.index') }}</th>
