...
@section('title')
    {{ __('owner.generated.item_7dcac6') }}
@endsection
@section('css')
...
@section('content')
    ...
    <div class="d-flex align-items-center mb-3">
        <div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">{{ __('owner.crew.edit.breadcrumb_manage') }}</a></li>
                <li class="breadcrumb-item active">{{ __('owner.generated.create_new_crew') }}</li>
            </ul>
            <h1 class="page-header mb-0">{{ __('owner.generated.create_new_crew') }}</h1>
        </div>
    ...
    <div id="formControls" class="mb-5">
        <div class="card">
            <div class="card-body pb-2">
                <form action="{{ route('owner.crew.store') }}" id="createForm" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-4">
