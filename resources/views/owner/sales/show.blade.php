        ...
        <div class="card">
            <div class="card-body pb-2">
                ...
                <div class="row mb-3">
                    ...
                    <h6 class="mb-4">{{ __('owner.sales.payment_status') }}: @if ($sales->payment_status == 'paid')
                            {{ __('owner.generated.item_7a262d') }}
                        @elseif ($sales->payment_status == 'partially_paid')
                            {{ __('owner.generated.item_cd0da4') }}
                        @else
                            {{ __('owner.generated.item_55508f') }}
                        @endif
                    </h6>
                        ...
                        <tbody>
                            @foreach ($sales->details as $detail)
                                <tr>
                                    ...
                                    <td>{!! number_format($detail->total_price, 2) . ' ' . $riyalIcon !!}</td>
                                </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
                            <tr>
                                ...
                                <th></th>
                                <th>{!! number_format($sales->details->sum('total_price'), 2) . ' ' . $riyalIcon !!}</th>
                            </tr>
                            @if ($sales->payment_status == 'partially_paid')
                                <tr>
                                    <th colspan="4">{{ __('owner.status.paid') }}</th>
                                    <th>{!! number_format($sales->details->sum('total_price') - $sales->remaining_total, 2) . ' ' . $riyalIcon !!}</th>
                                </tr>
                                <tr>
                                    <th colspan="4">{{ __('owner.generated.remaining_val') }}</th>
                                    <th>{!! number_format($sales->remaining_total, 2) . ' ' . $riyalIcon !!}</th>
                                </tr>
                            @endif
                        </tfoot>
                    </table>
