...
@section('title', __('owner.menu.payrolls'))
@section('css')
...
@section('content')
    <div class="container-fluid mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-bold mb-2">{{ __('owner.menu.payrolls') }}</h2>
            </div>
            <div>
                <a href="{{ route('owner.payrolls.create') }}" class="btn btn-outline-theme btn-equal">
