        ...
        <div class="menu">
            ...
            @if(auth('owner')->user()?->hasBusinessStartupAccess())
                <div class="menu-item has-sub {{ request()->routeIs('owner.startup.*') ? 'active' : '' }}">
                    <a href="#" class="menu-link"><span class="menu-icon"><i class="bi bi-briefcase"></i></span><span class="menu-text">{{ __('owner.startup.menu.title') }}</span><span class="menu-caret"><b class="caret"></b></span></a>
                    <div class="menu-submenu">
