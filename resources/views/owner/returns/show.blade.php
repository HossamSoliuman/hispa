...
@section('title')
{{__('owner.returns.title')}} - {{__('owner.returns.view')}}
@endsection
@section('css')
...
<div class="d-flex align-items-center mb-3">
    <div>
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{__('owner.returns.view')}}</li>
        </ul>
        <h1 class="page-header mb-0">{{__('owner.returns.view')}}</h1>
    </div>
</div>
<div id="formControls" class="mb-5">
    <div class="card">
        <div class="card-body pb-2">
                ...
                <div class="row mb-3">
                    <h5>{{ __('owner.returns.sale_number') }}: {{ $return->sale->number }}</h5>
                    <h6>{{ __('owner.returns.returned_at') }}: {{ $return->returned_at }}</h6>
                    <h6>{{ __('owner.returns.status') }}: @if($return->status == 'approved') {{ __('owner.returns.approved') }} @endif</h6>
