...
>
    <div class="checkout-frame">
        <span class="checkout-frame-corners" aria-hidden="true">
            <i class="checkout-corner-top-start"></i>
            <i class="checkout-corner-top-end"></i>
            <i class="checkout-corner-bottom-start"></i>
            <i class="checkout-corner-bottom-end"></i>
        </span>
        ...
        <section class="checkout-workspace">
            <header class="checkout-topbar">
                ...
                <span class="checkout-topbar-actions">
                    <button
                        type="button"
                        class="checkout-theme-toggle"
                        data-theme-toggle
