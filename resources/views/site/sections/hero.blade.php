<section id="home" class="relative isolate overflow-hidden border-b border-ocean/20 bg-white/45">
    ...
    <div class="site-shell relative z-10 grid items-center gap-16 py-24 lg:grid-cols-[0.78fr_1.22fr] lg:py-32 xl:gap-20">
        <div class="hero-rise text-start">
            <span class="eyebrow text-ocean">{{ __('marketing.hero.eyebrow') }}</span>
            <h1 class="mt-7 max-w-xl text-[clamp(2.65rem,6vw,5rem)] font-bold leading-[1.08] tracking-[-0.045em] text-ink">
                {{ __('marketing.hero.title') }}
            </h1>
            <p class="mt-7 max-w-lg text-base leading-8 text-ink/62 md:text-lg">
            ...
            <p class="mt-6 flex items-start gap-2 text-xs leading-6 text-ink/48">
    ...
    <div class="relative z-10 border-t border-ocean/15 bg-white/65">
        <div class="site-shell grid divide-y divide-ocean/12 py-1 sm:grid-cols-3 sm:divide-x sm:divide-y-0 sm:rtl:divide-x-reverse">
            @foreach([__('marketing.hero.proof_1'), __('marketing.hero.proof_2'), __('marketing.hero.proof_3')] as $proof)
                <p class="flex items-center justify-center gap-2 py-5 text-center text-xs font-medium text-ink/58">
