...
return [
    ...
    // حد القوارب حسب الباقة
    'boat_limit_reached' => 'لقد وصلت إلى الحد الأقصى لعدد القوارب في باقتك (:limit). يرجى ترقية اشتراكك لإضافة المزيد.',
    'no_active_subscription' => 'لا يوجد اشتراك فعّال. لا يمكنك إضافة قوارب حتى يتم تفعيل اشتراكك.',
];
